...
($context["view_mode"] ?? null)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null)))) : ("")), 5 => "clearfix"];
  ...
  <div";
    ...
    ";
      ...
      ";
        // line 109
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\devel\Twig\Extension\Debug')->message($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute(($context["node"] ?? null), "field_package_type", []), 0, []), "value", []))]));
        echo "
    </div>
...
<article{{ attributes.addClass(classes) }}>
  ...
  <div{{ content_attributes.addClass('content') }}> 
    ...
    <div class=\"package_details_banner\">
      ...
      {{ dpm(node.field_package_type.0.value) }}
    </div>
    <div class=\"container clearfix\">
    <div class=\"ootb-tabcordion\">
      <div class=\"ootb-tabcordion--tabs\" role=\"tablist\" aria-label=\"TabCordion\">
