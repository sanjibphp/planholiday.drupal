...
($context["view_mode"] ?? null)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null)))) : ("")), 5 => "clearfix"];
  ...
  <div";
    ...
    ";
      ...
      ";
        // line 109
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\devel\Twig\Extension\Debug')->message($this->env, $context, [0 => $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["node"] ?? null), "field_package_type", []))]));
        echo "
    </div>
